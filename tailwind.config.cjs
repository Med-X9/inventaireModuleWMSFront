  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        success:   { DEFAULT: '#00ab55', light: '#ddf5f0', 'dark-light': 'rgba(0,171,85,.15)' },
        danger:    { DEFAULT: '#e7515a', light: '#fff5f5', 'dark-light': 'rgba(231,81,90,.15)' },
        warning:   { DEFAULT: '#fec63f', light: '#fff9ed', 'dark-light': 'rgba(226,160,63,.15)' },

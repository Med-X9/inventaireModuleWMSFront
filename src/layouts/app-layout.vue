...
<script setup lang="ts">
    ...
    import { createMdiIconComponent } from '@/utils/createMdiIconComponent';
    // i18n
    ...
    const IconMenuDashboard = createMdiIconComponent('mdi-view-dashboard-outline');
    const IconMenuInventory = createMdiIconComponent('mdi-clipboard-list-outline');

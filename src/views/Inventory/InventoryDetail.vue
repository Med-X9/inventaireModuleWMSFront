                ...
                >
                  ...
                  <div class="space-y-2">
                    <div class="flex flex-wrap gap-2">
                      ...
                      <span 
                        v-if="comptage.inputMethod === 'scanner' || comptage.scannerUnitaire" 
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs  text-primary-600 bg-gray-100 dark:bg-gray-700 shadow-sm hover:shadow-md transition-shadow"
                      >
                        Scanner unitaire
                      </span>
                      ...
                      <span 
                        v-if="comptage.inputMethod === 'saisie' || comptage.saisieQuantite" 
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs  text-primary-600 bg-gray-100 dark:bg-gray-700 shadow-sm hover:shadow-md transition-shadow"
                      >
                       Saisie quantité
                      </span>
                  ...
                  >
                    <template #contenu>
                      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                        <!-- En attente -->
                        <div class="flex items-center justify-between bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-lg px-4  hover:shadow-md transition-all duration-300 hover:-translate-y-0.3 h-9.5">
                          <div class="flex items-center">
                            <div class="flex items-center space-x-1">
                              <div class="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
                              <div class="w-1 h-1 bg-primary rounded-full opacity-60"></div>
                              <div class="w-1 h-1 bg-primary rounded-full opacity-30"></div>
                            </div>
                            <span class="text-sm font-medium text-gray-600 ml-3">En attente</span>
                          </div>
                          <div class="flex items-center">
                            <span class="text-lg font-medium text-gray-800 mr-2">{{ getRemainingJobsCount(tab.id) }}</span>
                          </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-lg px-4  hover:shadow-md transition-all duration-300 hover:-translate-y-0.3 h-9.5">
                          <div class="flex items-center">
                            <div class="flex items-center space-x-1">
                              <div class="w-1.5 h-1.5 bg-info rounded-full animate-bounce"></div>
                              <div class="w-1.5 h-1.5 bg-info rounded-full animate-bounce" style="animation-delay: 0.1s"></div>
                              <div class="w-1.5 h-1.5 bg-info rounded-full animate-bounce" style="animation-delay: 0.2s"></div>
                            </div>
                            <span class="text-sm font-medium text-gray-600 ml-3">En cours</span>
                          </div>
                          <div class="flex items-center">
                            <span class="text-lg font-medium text-gray-800 mr-2">{{ getInProgressJobsCount(tab.id) }}</span>
                          </div>
                        </div>

                        <!-- Terminés -->
                        <div class="flex items-center justify-between bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-lg px-4 h-9.5 hover:shadow-md transition-all duration-300 hover:-translate-y-0.3">
                          <div class="flex items-center">
                            <div class="flex items-center">
                              <div class="w-2 h-2 bg-success rounded-full relative">
                                <div class="absolute inset-0 w-2 h-2 bg-success rounded-full animate-ping opacity-40"></div>
                              </div>
                          ...
                          <div class="flex items-center">
                            <span class="text-lg  font-medium  text-gray-800 mr-2">{{ getCompletedJobsCount(tab.id) }}</span>
                          </div>
                        </div>
                      </div>
                    </template>

<template>
  <div class="relative flex h-screen items-center justify-center bg-gray-200 px-6 py-10 sm:px-16">
    <div
      class="relative w-full max-w-[870px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)] max-h-full overflow-auto"
    >
      <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 py-20">
        <div class="mx-auto w-full max-w-[440px] text-center">
          ...
          <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-2xl mb-5">
            Se connecter
          </h1>
...
/** Redirige vers "/" si handleLogin() renvoie true */

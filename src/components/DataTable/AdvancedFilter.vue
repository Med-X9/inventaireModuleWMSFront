<template>
    <div class="advanced-filter">
        ...
        <!-- Contrôles de filtre selon le type -->
        <div class="filter-controls">
            ...
            <div v-else-if="isSelectFilter" class="select-filter">
...
import type { FilterConfig, ColumnDataType, FilterOperator } from '@/types/dataTable'
...
// Mettre à jour les opérateurs disponibles quand le type de données change
